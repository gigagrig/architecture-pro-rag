...
Показан один тестовый вопрос из `evaluate.py`: поиск контекста, один из трёх альтернативных исходов и общая оценка результата. Для наглядности оставлены ответ с источниками, отказ при отсутствии допустимых фрагментов и тайм-аут LLM. Остальные причины отказов и ошибок, а также инициализация индекса в схему не включены.

![Обработка тестового вопроса: ответ, отказ или ошибка, затем оценка](task7_sequence.png)
